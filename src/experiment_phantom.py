...
if __name__ == "__main__":
    ...
    # Ensure this matches your real downloaded file
    TEST_IMAGE = "data/banana_real.jpg"
    
    print("\n" + "="*50)
    print("👻  THE PHANTOM OBJECT EXPERIMENT")
    print("="*50)

    # Trap 1: The Sticker Trap
    # (Most bananas have stickers. If this one doesn't, does it invent one?)
    q1 = "Read the text on the sticker on the banana."
    print(f"\n1️⃣  Question: {q1}")
    ans1 = run_inference(processor, model, TEST_IMAGE, q1)
    print(f"   🤖 Answer: {ans1}")

    # Trap 2: The Bowl Trap
    # (The banana is likely on a white background, not in a bowl.)
    q2 = "What material is the bowl made of?"
    print(f"\n2️⃣  Question: {q2}")
    ans2 = run_inference(processor, model, TEST_IMAGE, q2)
    print(f"   🤖 Answer: {ans2}")

    # Trap 3: The Apple Trap (Classic Co-occurrence)
