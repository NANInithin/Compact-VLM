...
def run_inference(processor, model, image_path, question):
    ...
    # We force the model to "Audit" the image first.
    cot_instruction = (
        "You are a precise visual inspector. Follow these two steps strictly:\n"
        "1. VISUAL AUDIT: List every object you clearly see in the image.\n"
        "2. ANSWER: Answer the user's question using ONLY the objects listed in Step 1.\n"
        "If the object asked about is not in your list, say 'I do not see that object.'\n"
    )
...
if __name__ == "__main__":
    ...
    TEST_IMAGE = "data/banana_real.jpg"
    
    print("\n" + "="*50)
    print("🧠  THE CHAIN-OF-THOUGHT EXPERIMENT")
    print("="*50)
    ...
    # Trap 2: The Bowl (The Boss Battle)
